      ...
      <div className="flex-1 lg:ml-0 p-4 sm:p-6 lg:p-10 pt-16 lg:pt-10">
        ...
        <div className="mb-8 lg:mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-3 sm:gap-4 lg:gap-6">
            <div onClick={() => setActiveCategory("Todas")}
              className={`cursor-pointer transition-all duration-200 hover:scale-105 ${activeCategory === "Todas" ? "ring-2 ring-purple-500 ring-offset-2 ring-offset-[#0a0b0f] scale-105" : ""}`}>
              <CategoryCard icon="chart" title="Todas" type="General" />
            </div>

            {categories.map((cat, index) => (
              <div key={index} onClick={() => setActiveCategory(cat.title)}
                className={`cursor-pointer transition-all duration-200 hover:scale-105 ${activeCategory === cat.title ? "ring-2 ring-purple-500 ring-offset-2 ring-offset-[#0a0b0f] scale-105" : ""}`}>
